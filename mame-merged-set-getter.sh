...
source $(pwd)/update_mame-getter.ini
   ...
   do
      ...
      then
         ...
         case "$VER" in
            ...
            '0268')
                  curl ${CURL_RETRY} ${SSL_SECURITY_OPTION} -u $user --location -o "${ZIP_PATH}" "https://bda.retroroms.info:82/downloads/mame/mame-0268/${f}"
                     ;;	  
            '0269')
                  curl ${CURL_RETRY} ${SSL_SECURITY_OPTION} -u $user --location -o "${ZIP_PATH}" "https://bda.retroroms.info:82/downloads/mame/mame-0269/${f}"
                     ;;	  
            '0270')
                  curl ${CURL_RETRY} ${SSL_SECURITY_OPTION} -u $user --location -o "${ZIP_PATH}" "https://bda.retroroms.info:82/downloads/mame/mame-0270/${f}"
                     ;;	  
            *)
...
arc_ether2_aeh50.zip
arc_ether3_aeh54.zip
arc_ethera.zip
arc_etherd.zip
arc_etherr.zip
arc_faxpack.zip
...
centauri.zip
centauri2.zip
centennial_sl01m_15_11194.zip
centennial_sl02m_15_11194.zip
centennial_sl04m_15_11194.zip
centipdb.zip
centipdb2.zip
centipdd.zip
centiped.zip
...
heath_imaginator_tlb.zip
heath_super19_tlb.zip
heath_superset_tlb.zip
heath_tlb.zip
heath_ultra_tlb.zip
heath_watz_tlb.zip
heatof11.zip
...
tanbus_tanex.zip
tanbus_vid8082.zip
tandberg_tdv2100_disp_logic.zip
tandberg_tdv2100_keyboard.zip
tandy102.zip
tandy200.zip
tandy2k.zip
tangtang.zip
